...
export const works = [
    { id: 1, company: "MARTINS ADVOGADOS ASSOCIADOS", role: "Desenvolvedor Front-End React JS", duration: "(Nov 2022 - atualmente)", activities: "Desenvolvimento do sistema para controle de processos, clientes e advogados e geração dos contratos e minutas solicitado pelo escritório. Elaboração do layout e design do sistema e integração com o back-end. Desenvolvimento com ReactJs." },
    ...
    { id: 3, company: "AR E2S CORRETORA DE SEGUROS LTDA-ME", role: "Analista de Suporte Computacional", duration: "(Set 2020 - Ago 2022)", activities: "Suporte de T.I, atendimento aos clientes, emissor de Certificados Digitais (AGR- Agente de Registro), treinamento dos funcionários e análise de documentos. Desenvolvimento do site portflólio e do sistema web interno da empresa." },
