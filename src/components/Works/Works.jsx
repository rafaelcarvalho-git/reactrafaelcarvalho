  ...
  return (
    <section id="works" className="bg-dark text-white">
      <div className="pt-4">
        ...
        <div id="workCarousel" class="carousel slide mx-auto py-4" data-bs-ride="false">
          <div class="carousel-indicators">
            <button type="button" data-bs-target="#workCarousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
          ...
          <div class="carousel-inner mx-auto container">
            <div class="carousel-item active">
              <div className="work pt-3 pb-3">
                <h4 className="text-center fw-bold">E2S CORRETORA DE SEGUROS LTDA-ME</h4>
                <h5 className="text-center fw-bold">Analista de Suporte Computacional (Set 2020 - Ago 2022)</h5>
          ...
          <button class="carousel-control-prev bg-info" type="button" data-bs-target="#workCarousel" data-bs-slide="prev">
