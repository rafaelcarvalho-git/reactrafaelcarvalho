...
var works = [
  { id: 1, company: "AR E2S CORRETORA DE SEGUROS LTDA-ME", role: "Analista de Suporte Computacional", duration: "(Set 2020 - Ago 2022)", activities: "Suporte de T.I, atendimento aos clientes, emissor de Certificados Digitais (AGR- Agente de Registro), treinamento dos funcionários, gerenciamento de sistemas e análise de documentos. Desenvolvimento do site portflólio e do sistema web interno da empresa." },
  ...
  return (
    <section id="works" className="bg-dark text-white">
      <div className="container pb-4">
        <h2 className="text-center fw-bold pt-4 mb-5">Experiência</h2>
              ...
              if (work.id == workList) {
                return (
                  <div key={work.id} className="py-4 px-2">
                    ...
                    <h5 className="tt fw-bold mb-4">{work.company}</h5>
                    <p>{work.activities}</p>
                  </div>
                )
              }
